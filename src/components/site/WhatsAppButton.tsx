...
export function WhatsAppButton() {
  return (
    ...
    >
      ...
      <span className="relative grid place-items-center h-14 w-14 rounded-full bg-foreground text-background shadow-[0_8px_24px_-12px_rgba(0,0,0,0.5)] hover:scale-105 transition-transform">
